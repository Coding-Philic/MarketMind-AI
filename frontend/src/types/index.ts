export interface MarketEvent {
  ...
  rawSource: 'News' | 'SEC Filing' | 'Product Release' | 'Earnings Call' | 'Regulatory Body' | 'Simulation Engine';
}
...
export interface ProductPerformance {
  ...
  revenueShare?: number; // percentage of total company revenue generated by this product (0 to 100)
  rating?: number; // customer/analyst satisfaction or adoption rating (e.g. 4.7 out of 5.0)
  reviewCount?: number; // number of analyst reports or market reviews tracked
  category?: string; // product category / sector division (e.g., "Cloud & AI", "Hardware", "Services")
}
...
export interface MemoryNode {
  id: string;
  label: string;
  group: 'company' | 'product' | 'event' | 'hindsight_lesson' | 'sector' | 'theme';
  detail: string;
